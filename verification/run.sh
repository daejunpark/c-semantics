...
K_OPTS=-Xmx4g krun -v --debug --prove rbt_find_spec.k     --parser "kast --parser binary" rbt.o  --smt_prelude ../../k/k-distribution/include/z3/search_tree.smt2 -cOPTIONS="(.Set)" -cARGV="(ListItem(\"./rbt\") .List)" -cARGC=1
K_OPTS=-Xmx4g krun -v --debug --prove rbt_insert_spec.k   --parser "kast --parser binary" rbt.o  --smt_prelude ../../k/k-distribution/include/z3/search_tree.smt2 -cOPTIONS="(.Set)" -cARGV="(ListItem(\"./rbt\") .List)" -cARGC=1
K_OPTS=-Xmx4g krun -v --debug --prove rbt_delete_spec.k   --parser "kast --parser binary" rbt.o  --smt_prelude ../../k/k-distribution/include/z3/search_tree.smt2 -cOPTIONS="(.Set)" -cARGV="(ListItem(\"./rbt\") .List)" -cARGC=1
