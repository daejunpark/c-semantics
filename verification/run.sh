...
K_OPTS=-Xmx6g krun -v --debug --prove treap_find_spec.k   --parser "kast --parser binary" treap.o --smt_prelude $SMT_PRELUDE_DIR/search_tree.smt2 -cOPTIONS="(.Set)" -cARGV="(ListItem(\"./treap\") .List)" -cARGC=1
K_OPTS=-Xmx6g krun -v --debug --prove treap_insert_spec.k --parser "kast --parser binary" treap.o --smt_prelude $SMT_PRELUDE_DIR/search_tree.smt2 -cOPTIONS="(.Set)" -cARGV="(ListItem(\"./treap\") .List)" -cARGC=1
K_OPTS=-Xmx6g krun -v --debug --prove treap_delete_spec.k --parser "kast --parser binary" treap.o --smt_prelude $SMT_PRELUDE_DIR/search_tree.smt2 -cOPTIONS="(.Set)" -cARGV="(ListItem(\"./treap\") .List)" -cARGC=1
